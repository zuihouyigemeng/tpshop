...
function(a) {
    a.fn.cxScroll = function(b) {
        ...
        d.init = function() {
            if (d.dom.box = c.find(".box"), d.dom.list = d.dom.box.find(".list"), d.dom.items = d.dom.list.find("ul"), d.itemSum = d.dom.items.length, !(d.itemSum <= 1)) {
                ...
                b.nextBtn && !d.dom.nextBtn.length && (d.dom.nextBtn = a("<a></a>", {
                    "class": "next"
                }).prependTo(c)),
